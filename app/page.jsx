        ...
        >
          <div className="grid grid-cols-2 items-center mx-auto w-[70%] max-sm:w-full  my-4 gap-6">
            <input
              ...
              className="border-2 outline-none border-black/40 max-sm:py-2 py-4 px-2 rounded-md"
            />
            <input
              type="text"
              name="lastName"
          ...
          <textarea
            ...
            rows="5"
            placeholder="Message"
            className="border-2 mb-8 outline-none border-black/40 py-4 px-2 rounded-md w-[70%] max-sm:w-full  "
          ></textarea>
